          ...
          <div className="featured-article animate-on-scroll">
            ...
            <div className="featured-article-body" style={{ position: 'relative' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', lineHeight: 1.9, marginBottom: '20px' }}>
                Perawatan ibu dan bayi bukan sekadar layanan relaksasi — ini adalah bagian penting dari perjalanan kesehatan dan ikatan emosional antara ibu dan buah hati. Sentuhan lembut yang dilakukan melalui pijat dan terapi perawatan dapat membawa manfaat yang telah didukung oleh riset kesehatan dan praktik klinis.
              </p>
